...
struct VolunteerOfficerDashboardView: View {
    ...
    @AppStorage("volunteerOfficerDashboardTotalsWindow") private var selectedWindowRawValue = DashboardTotalsWindow.ytd.rawValue
